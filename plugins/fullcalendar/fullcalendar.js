...
fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
	...
	(function($) {
		// Your existing language setting function
		...
		// Assuming dpLangCode and langCode are defined elsewhere in your code
		// dpLangCode: the language code for FullCalendar/MomentJS
		// langCode: the language code for Datepicker
	
		// Check if datepicker.tr is defined
		if ($.datepicker.regional['tr']) {
			// If defined, set both dpLangCode and langCode to 'tr'
			dpLangCode = langCode = 'tr';
		}
...
var dayIDs = [ "Pz", "Pzt", "Sal", "Çrş", "Prş", "Cu", "Cts", "Pz" ];
